...
qplot(activity2ByDate$TotalSteps, binwidth = 1000, main = "XXX",xlab = "Total Steps by Date", ylab = "Frequency")  
...
finalPlot <- qplot(interval, 
           StepsMean, data = dataFinalPlot, geom = 'line', xlab = "5-minute interval",ylab = 'Number of steps') 
